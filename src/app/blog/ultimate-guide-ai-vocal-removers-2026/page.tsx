...
const post = BLOG_POSTS.find((item) => item.slug === "ultimate-guide-ai-vocal-removers-2026");

export const metadata = {
  title: "The Ultimate Guide to AI Vocal Removers | TuneVid Blog",
  description:
...
export default function BlogPostStaticPage() {
  if (!post) {
    return (
      <div className="mx-auto max-w-4xl px-6 py-14 text-zinc-900 dark:text-zinc-100">
        <h1 className="text-2xl font-semibold">Article not found</h1>
        <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">Please return to the blog.</p>
        <Link href="/blog" className="mt-4 inline-flex text-sm font-semibold text-emerald-600">Go to blog</Link>
      </div>
    );
  }
