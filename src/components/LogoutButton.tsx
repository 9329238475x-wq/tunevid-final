...
export default function LogoutButton() {
    ...
    const buttonStyle = {
        ...logoutButtonStates[state],
        '--figure-duration': `${logoutButtonStates[state]['--figure-duration']}ms`,
        '--walking-duration': `${logoutButtonStates[state]['--walking-duration']}ms`,
    } as React.CSSProperties;

    return (
        <button
            className={`logoutButton logoutButton--dark relative ${isClicked ? 'clicked' : ''} ${isDoorSlammed ? 'door-slammed' : ''} ${isFalling ? 'falling' : ''}`}
            style={buttonStyle}
        ...
        >
            ...
            <span className="button-text font-bold">Sign Out</span>
        </button>
    );
}
